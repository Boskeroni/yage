...
note from me: I have edited the boot rom so that it doesnt 
enter an infinite loop due to the incorrect headsum checker.

0xFA used to be 0x20 but is now 0x00
0xFB used to be 0xFE but is now 0x00